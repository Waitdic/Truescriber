...
namespace Truescriber.DAL.Migrations
{
    ...
    [Migration("20190815095859_DeleteFilePathFromTask")]
    partial class DeleteFilePathFromTask
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Truescriber.DAL.Entities.Tasks.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Truescriber.DAL.Entities.User")
                        .WithMany()
